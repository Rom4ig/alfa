...
export class MainPage extends BasePage {
  ...
  async addFirstItemsWithCountAndDiscount(count: number, isDiscount: boolean = false, startNumber: number = 0) {
    const items = isDiscount ? this.page.locator("//div[contains(@class, 'note-list')]//*[contains(@class, 'hasDiscount')]//button") :
      this.page.locator("//div[contains(@class, 'note-list')]//*[not(contains(@class, 'hasDiscount')) and contains(@class, 'note-item')]//button")
